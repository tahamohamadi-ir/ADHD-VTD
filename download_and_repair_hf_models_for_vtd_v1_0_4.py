...
# -*- coding: utf-8 -*-
r"""
VTD / ADHD-VTD Hugging Face Model Downloader + Verifier + Repairer v1.0.4
===================================================================
...
MODELS: list[ModelSpec] = [
    ...
    ModelSpec("Qwen3-0.6B-GGUF", "Qwen/Qwen3-0.6B-GGUF", "generation", "gguf", "tiny", local_name_hints=("qwen3-0.6b", "qwen3-06b"), min_size_mb=300),
    ...
    ModelSpec("Gemma-3-1B-Instruct-GGUF", "lm-kit/gemma-3-1b-instruct-gguf", "generation", "gguf", "small", local_name_hints=("gemma-3-1b", "gemma3-1b"), min_size_mb=500),
    ...
    # Prefer the Instruct-2507 build when available because the user already had that local file.
    ModelSpec("Qwen3-4B-Instruct-2507-GGUF", "Qwen/Qwen3-4B-Instruct-2507-GGUF", "generation", "gguf", "medium", local_name_hints=("qwen3-4b-instruct-2507", "qwen3-4b"), preferred_filename="Qwen3-4B-Instruct-2507-Q4_K_M.gguf", min_size_mb=1800),
    ModelSpec("Qwen3-4B-GGUF", "Qwen/Qwen3-4B-GGUF", "generation", "gguf", "medium", local_name_hints=("qwen3-4b",), preferred_filename="Qwen3-4B-Q4_K_M.gguf", min_size_mb=1800),
    ModelSpec("Qwen3.5-4B-GGUF", "lmstudio-community/Qwen3.5-4B-GGUF", "generation", "gguf", "medium", local_name_hints=("qwen3.5-4b", "qwen35-4b"), preferred_filename="Qwen3.5-4B-Q4_K_M.gguf", min_size_mb=1800),
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Download, verify, and repair VTD local models from Hugging Face. v1.0.4")
    ...
    print("=" * 80)
    print("VTD Hugging Face Model Downloader + Verifier + Repairer v1.0.4")
