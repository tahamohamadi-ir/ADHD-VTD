...
def recommend_chart(execution_result: List[Dict[str, Any]] | None) -> Dict[str, str]:
    ...
    if num_rows > 1 and num_cols == 2:
        return {"recommended_visual": "bar_chart", "chart_reason": "Two columns typically represent a dimension and a metric"}
    ...
    if num_rows > 1 and num_cols >= 3:
        ...
        return {"recommended_visual": "heatmap", "chart_reason": "Matrix data suitable for heatmap or stacked bar chart"}
