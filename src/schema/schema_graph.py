...
class SchemaGraph:
    ...
    def __init__(self, graph_path: str | Path | None = None, snapshot_path: str | Path | None = None) -> None:
    ...
    def _load(self) -> SchemaGraphModel:
        ...
        for e in graph.get("edges", []):
            source_cols = e.get("source_columns") or ([e.get("source_column")] if e.get("source_column") else [])
            target_cols = e.get("target_columns") or ([e.get("target_column")] if e.get("target_column") else [])
