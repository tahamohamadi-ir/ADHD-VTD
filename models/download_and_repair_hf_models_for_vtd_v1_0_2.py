...
# -*- coding: utf-8 -*-
r"""
VTD / ADHD-VTD Hugging Face Model Downloader + Verifier + Repairer
===================================================================
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Download, verify, and repair VTD local models from Hugging Face.")
    ...
    print("=" * 80)
    print("VTD Hugging Face Model Downloader + Verifier + Repairer")
