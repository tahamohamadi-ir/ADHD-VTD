...
# -*- coding: utf-8 -*-
r"""
VTD / ADHD-VTD Hugging Face Model Downloader + Verifier + Repairer v1.0.3
===================================================================
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Download, verify, and repair VTD local models from Hugging Face. v1.0.3")
    ...
    print("=" * 80)
    print("VTD Hugging Face Model Downloader + Verifier + Repairer v1.0.3")
