...
پوشه `_DELETE_REVIEW/` (در صورت وجود) محلی است برای فایل‌های کاندیدای حذف؛ فقط move می‌شوند و هرگز commit نمی‌شوند. راهنمای بازگردانی: `_DELETE_REVIEW/README.md`.
